...
| 📘 **МЕТОДОЛОГИЯ (База Знаний)** | 🛠 **ИНСТРУМЕНТЫ (Toolkit)** |
| :--- | :--- |
| **📄 [Описание Методологии](./GLB_STANDARD/methodology.md)**<br>_Единый стандарт для всех уровней_<br><br>🟢 **Level 1: Easy Mode**<br>↳ _Базовый скоринг и экспресс-анализ_<br><br>🔵 **Level 2: Pro Mode**<br>↳ _Глубокий технический разбор кода_<br><br>🟣 **Level 3: Research**<br>↳ _Исследование рынка и конкурентов_<br><br>🟡 **Level 4: Summary**<br>↳ _Сводная аналитика и выводы_ | **📂 [templates/](./GLB_STANDARD/templates/)**<br>_Готовые Markdown-шаблоны_<br><br>📝 **[Шаблон Аудита: EASY](./GLB_STANDARD/templates/GLB_AUDIT_EASYMOD.md)**<br>_Быстрый старт_<br><br>📝 **[Шаблон Аудита: PRO](./GLB_STANDARD/templates/GLB_AUDIT_PROMOD.md)**<br>_Детальный разбор_<br><br>📝 **[Шаблон Research](./GLB_STANDARD/templates/GLB_RESEARCH.md)**<br>_Структура для DYOR_<br><br>📝 **[Шаблон Summary](./GLB_STANDARD/templates/GLB_SUMMARY_MOD.md)**<br>_Финальный отчет_<br><br>---<br>📊 **[diagrams/](./GLB_STANDARD/diagrams/)** — Схемы процессов<br>💡 **[examples/](./GLB_STANDARD/examples/)** — Примеры аудитов |
