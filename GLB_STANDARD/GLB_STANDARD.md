...
| :--- | :--- |
| **📄 [Methodology Guide](./methology/methodology.md)**<br>_Unified standard for all levels_<br><br>🟢 **Level 1: Easy Mode**<br>↳ _Basic scoring and express analysis_<br><br>🔵 **Level 2: Pro Mode**<br>↳ _Deep technical code analysis_<br><br>🟣 **Level 3: Research**<br>↳ _Market and competitor research_<br><br>🟡 **Level 4: Summary**<br>↳ _Summary analytics and conclusions_ | **📂 [templates/](./GLB_STANDARD/templates/)**<br>_Ready-to-use Markdown templates_<br><br>📝 **[Audit Template: EASY](./GLB_STANDARD/templates/GLB_AUDIT_EASYMOD.md)**<br>_Template for a quick start_<br><br>📝 **[Audit Template: PRO](./GLB_STANDARD/templates/GLB_AUDIT_PROMOD.md)**<br>_Template for detailed audit_<br><br>📝 **[Research Template](./GLB_STANDARD/templates/GLB_RESEARCH.md)**<br>_Structure for DYOR_<br><br>📝 **[Summary Template](./GLB_STANDARD/templates/GLB_SUMMARY_MOD.md)**<br>_Final report_<br><br>---<br>📊 **[diagrams/](./GLB_STANDARD/diagrams/)** — Process workflows<br>💡 **[examples/](./GLB_STANDARD/examples/)** — Examples of completed audits |
